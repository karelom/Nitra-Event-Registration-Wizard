    ...
    <template v-else>
      ...
      >
        ...
        <AttendeeInfoRow
          ...
          "
          :has-error="fieldHasError('attendeeInfo', 'fullName')"
        />
        <AttendeeInfoRow
          label="Email"
          :value="
          ...
          "
          :has-error="fieldHasError('attendeeInfo', 'email')"
        />
        <AttendeeInfoRow
          label="Phone"
          :value="
          ...
          "
          :has-error="fieldHasError('attendeeInfo', 'phone')"
        />
        <AttendeeInfoRow
          label="Company"
          :value="
          ...
          "
          :has-error="fieldHasError('attendeeInfo', 'company')"
        />
        <AttendeeInfoRow
          label="Job Title"
          :value="
          ...
          "
          :has-error="fieldHasError('attendeeInfo', 'jobTitle')"
        />
        <AttendeeInfoRow
          label="Ticket Type"
          :value="
            currentTicket
              ...
              : fieldHasError('attendeeInfo', 'ticketId')
                ...
                : '—'
          "
          :has-error="fieldHasError('attendeeInfo', 'ticketId')"
        />
        <AttendeeInfoRow
          v-if="
          ...
          :value="registration.attendeeInfo.shippingAddress || '— (required for merchandise)'"
          :has-error="fieldHasError('attendeeInfo', 'shippingAddress')"
        />
      </section>
