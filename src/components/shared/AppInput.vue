...
<template>
  <div class="flex flex-col gap-1.5 flex-1 min-w-0">
    ...
    <input
      ...
      class="w-full px-3 py-2 text-base bg-surface-l0 rounded-md text-neutral placeholder:text-neutral-quiet leading-6 focus:outline-none transition-colors border-solid"
      :class="
        props.error
